      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <div role="button" className="flex items-center text-sm p-3 w-full hover:bg-primary/5">
            ...
            <ChevronsDownUpIcon className="w-4 h-4 ml-auto text-muted-foreground" />
          </div>
        </DropdownMenuTrigger>
        <DropdownMenuContent className="w-80" align="start" alignOffset={10} forceMount>
          ...
          <DropdownMenuItem asChild className="cursor-pointer text-muted-foreground w-full hover:bg-primary/5">
            <SignOutButton>
                Log out
            </SignOutButton>
          </DropdownMenuItem>
